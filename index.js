...
// ANSWER: By using an indexOf method, you can lessen the complexity to be constant, or O(1)
...
// ANSWER: Using map in this situation returns a copy without instantiating any new variables, allowing for a more simplified space complexity
function getNumbersSquared(numbers) {
